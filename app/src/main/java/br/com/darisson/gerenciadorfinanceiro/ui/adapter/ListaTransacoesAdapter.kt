package br.com.darisson.gerenciadorfinanceiro.ui.adapter
...
import br.com.darisson.gerenciadorfinanceiro.extension.limitaEmAte
...
class ListaTransacoesAdapter(private val transacoes: List<Transacao>,
    ...
    override fun getView(posicao: Int, view: View?, parent: ViewGroup?): View {
        ...
        adicionaDescricao(transacao, viewCriada)
    ...
    private fun adicionaDescricao(transacao: Transacao, viewCriada: View) {
        viewCriada.transacao_descricao.text = transacao.descricao
    }
